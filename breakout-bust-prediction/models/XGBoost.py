...
# Description: XGBoost classifier with hyperparameter tuning
...
class XGBoost():
    '''
    Class to tune, train and test an XGBoost classifier
    '''
    ...
    def __init__(self, kfold=5):
        ...
        self.model = GridSearchCV(
            estimator=xgb.XGBClassifier(objective="binary:logistic", seed=42), param_grid=self.grid, 
    ...
    def train(self, trainingData: list):
        '''
        Function to train XGBoost classifier. Each training instance will perform a grid search of
    ...
    def predict(self, x, proba: bool):
        '''
        Function to test trained XGBoost classifier on a test set.
